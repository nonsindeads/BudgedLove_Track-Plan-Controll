...
return [
    ...
    'Simulates one additional expense against the forecast including open items.' => 'Simulates one additional expense against the forecast including open items.',
    'Check' => 'Check',
    'Enter an amount to simulate the impact on this period.' => 'Enter an amount to simulate the impact on this period.',
    'e.g. 250,00' => 'e.g. 250.00',
    'Start import' => 'Start import',
    'Add recurring payment' => 'Add recurring payment',
    'Add transaction' => 'Add transaction',
    'Quick add transaction' => 'Quick add transaction',
    'Uses your last transaction as defaults.' => 'Uses your last transaction as defaults.',
    'Full transaction form' => 'Full transaction form',
    'Create an account and category before using quick add.' => 'Create an account and category before using quick add.',
